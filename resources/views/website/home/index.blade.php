            ...
            <div class="row" data-aos="fade-up">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        <li data-filter="*" class="filter-active allclass">All</li>
                        <li data-filter=".filter-app" class="app">App</li>
                        <li data-filter=".filter-card" class="card">Card</li>
                ...
                <div class="forshow">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app ">
                        ...
                        <div class="portfolio-info">
                            <h4>{{$app->title}}</h4>
                            <p>{{$app->category}}</p>
                            <a href="{{  asset('/').$app->image }}" data-gall="portfolioGallery" class="venobox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    @endforeach
                    ...
                    @if($webs)
                        @foreach($webs as $web)
                            <div class="col-lg-4 col-md-6 portfolio-item filter-web ">
                                <img src="{{asset($web->image)}}" class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>{{$web->title}}</h4>
                                    <p>{{$web->category}}</p>
                                    <a href="{{  asset('/').$app->image }}" data-gall="portfolioGallery" class="venobox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
