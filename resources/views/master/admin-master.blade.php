        ...
        <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
                <a href="">
                    ...
                    <span class="brand-name">Company Dashboard</span>
                </a>
            </div>
                    ...
                    <li  class="has-sub expand" >
                        ...
                        <ul  class="collapse show"  id="dashboard"
                            ...
                            <div class="sub-menu">
                                ...
                                <li  class="" >
                                    <a class="sidenav-item-link" href="{{route('manage.slider')}}">
                                ...
                                <li >
                                    <a class="sidenav-item-link" href="{{route('manage.about')}}">
                                        <span class="nav-text">Home About</span>
                                    </a>
                                </li>

                                <li >
                                    <a class="sidenav-item-link" href="{{route('manage.portfolio')}}">
                    ...
                    <li  class="has-sub expand" >
                        <a class="sidenav-item-link" href="" data-toggle="collapse" data-target="#ui-elements"
                           aria-expanded="false" aria-controls="ui-elements">
                            ...
                            <span class="nav-text">Contact Elements</span> <b class="caret"></b>
                        </a>
                        <ul  class="collapse"  id="ui-elements"
                            ...
                            <div class="sub-menu">
                                ...
                                <li   >
                                    <a class="sidenav-item-link" href="{{route('manage.contact')}}" >
                                ...
                                <li   >
                                    <a class="sidenav-item-link" href="{{ route('manage.message') }}">
    ...
    <div class="page-wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="dropdown-footer">
                                    <a href="" onclick="event.preventDefault(); document.getElementById('logoutForm').submit(); "> <i class="mdi mdi-logout"></i> Log Out </a>
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year">2019</span> Copyright Company Website by
                    <a
                        class="text-primary"
                        href=""
                        target="_blank"
                    >Shykot Hasan Shourav</a
                    >.
                </p>
            </div>
            <script>
